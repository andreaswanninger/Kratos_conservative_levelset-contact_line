...
PYBIND11_MODULE(KratosDropletDynamicsApplication,m)
{
    ...
    // AW 31.3 + AW 2.4
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IS_CUT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CURVATURE_FITTED_GP1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CURVATURE_FITTED_GP2)

    // AW 2.4
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,INTERFACE_GAUSS_POINT_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,INTERFACE_GAUSS_POINT_2)
